...
- **First-Launch Onboarding**: 4-step onboarding wizard (Welcome, Twitch, Discord, OBS Widget).
...
- **Unit Test Suite**: 210 unit tests across 16 test files covering bot commands, version comparison, onboarding navigation, Twitch view model state, WebSocket server, app constants integrity, cooldown management, Keychain service, artwork service, power state monitor, music playback monitor, Twitch device auth, Twitch chat service, and logger.
...
- This release marks the first stable version of WolfWave.
