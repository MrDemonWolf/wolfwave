...
### Changed
- Settings sidebar redesign. A VoiceInk-style sidebar with a branded header (mark, name, version), grouped rows with circular icon chips, and a solid accent-color selection pill with a hover highlight. Grouping, keyboard navigation, and VoiceOver are unchanged
