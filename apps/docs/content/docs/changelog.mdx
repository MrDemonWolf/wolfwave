...
- **Music permission flow** — onboarding now requests Apple Music library access via MusicKit with a graceful denied-state recovery path
...
- Onboarding flow polish — redundant success rows removed, Apple Music permission copy tightened
