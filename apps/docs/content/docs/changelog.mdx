...
### Added
- **Multi-source music support** — choose between Apple Music (direct, most accurate) and Any App (System), which picks up whatever's playing — Spotify, browsers, anything. Switch in the Music Monitor settings.
