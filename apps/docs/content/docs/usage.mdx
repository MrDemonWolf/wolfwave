...
- **Share the playlist**: Requests collect in a "WolfWave Requests" playlist in Apple Music. Make it public once, tap **Fetch link** in Settings, and `!playlist` shares the live link in chat.
