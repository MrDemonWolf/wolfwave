...
│   └── PowerStateMonitor.swift  # Low Power Mode and thermal pressure detection
├── Monitors/                # Music playback monitoring
│   └── MusicPlaybackMonitor.swift  # ScriptingBridge-based Apple Music integration
├── Services/                # External service integrations
│   ├── ArtworkService.swift     # iTunes Search API artwork fetching with cache
│   ├── Discord/
│   │   └── DiscordRPCService.swift  # Discord Rich Presence via IPC socket
│   ├── UpdateChecker/
│   │   ├── SparkleUpdaterService.swift   # Sparkle framework auto-update integration
...
│   │   └── WidgetHTTPService.swift       # Local HTTP server serving widget.html (port 8766)
│   └── Twitch/
...
│           ├── CooldownManager.swift   # Global and per-user cooldown system
...
└── Resources/              # Assets and resources
    ├── Assets.xcassets/
    └── widget.html             # Self-contained OBS widget (served by WidgetHTTPService)
```
