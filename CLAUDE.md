...
- **Services/Notifications/** — `NotificationService.swift` (opt-in song-change banner via `UNUserNotificationCenter`; reuses a stable identifier so a new track replaces the previous banner instead of stacking).
