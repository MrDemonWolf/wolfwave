...
- **Music Monitor**: Enable/disable Apple Music tracking, live now-playing preview
- **App Visibility**: Control dock/menu bar appearance
- **WebSocket**: Configure your WebSocket endpoint and authentication
- **Twitch**: Connect your Twitch account, configure the bot, and toggle individual commands
