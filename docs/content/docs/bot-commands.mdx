...
<Callout type="info">
  Each command group can be toggled on/off independently in **Settings → Twitch → Bot Commands**.
...
- **Configurable** — cooldowns can be adjusted per-command in **Settings → Twitch → Bot Commands**
